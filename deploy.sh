...
docker build -t $1/marmoset-cron-job-animals -t $1/marmoset-cron-job-animals:$(git rev-parse HEAD) ./cron/animals
...
docker push $1/marmoset-cron-job-animals:latest
docker push $1/marmoset-cron-job-animals:$(git rev-parse HEAD)
...
kubectl set image cronjobs/cron-job-animals cron-animals=$1/marmoset-cron-job-animals:$(git rev-parse HEAD)
